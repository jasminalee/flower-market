...
| **Preconditions:**                     | 1. The merchant has logged in to the  merchant management system and has "supplier information  management" permission.  2. The platform has initialized the  supplier management module. |
